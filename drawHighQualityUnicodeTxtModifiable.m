...
try
    % Choosing the display with the highest display number is a best guess 
    % about where you want the stimulus displayed.
    screens=Screen('Screens');
    screenNumber=max(screens);
    
    % Selects the high quality text renderer 
    Screen('Preference', 'TextRenderer', 1);

    % Enables text anti-aliasing for high quality text. 
    % Default is already anti-aliased rendering. 
    Screen('Preference', 'TextAntiAliasing', 1);

    % Disables user defined alpha-blending for text
    ...
    % default text style:
    Screen('TextFont',w, 'Segoe UI Symbol');
    ...
    %
    unicodetext = [10243, 10244, 10245, 10246, 10256, 10242, 10266, 10274, 10275, 10278, 103030 10303, ...
                    10303, 10303, 10303, 10303, 13, 10];
